...
Welcome to your new gem! In this directory, you'll find the files you need to be able to package up your Ruby library into a gem. Put your Ruby code in the file `lib/tech_cli_app`. To experiment with that code, run `bin/console` for an interactive prompt.
...
Bug reports and pull requests are welcome on GitHub at https://github.com/'zep1994'/tech_cli_app.
=======
